...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.storeRecipe = storeRecipe;\nexports.checkStorage = checkStorage;\n\n\nfunction storeRecipe() {\n    var currRecipeTitle = document.querySelector('.recipe__title').querySelector('span').textContent;\n    var recipesInSidebar = document.querySelector('.resultsPageNumber').querySelectorAll('li');\n\n    for (var i = 0; i < recipesInSidebar.length; i++) {\n        // Look in the search results and store the recipe that matches the currently loaded recipe.\n        if (currRecipeTitle === recipesInSidebar[i].querySelector('.results__name').textContent) {\n            var recipeToStore = recipesInSidebar[i].outerHTML;\n            var key = recipesInSidebar[i].querySelector('.results__link').href;\n\n            localStorage.setItem(key, recipeToStore);\n            var htmlAsString = localStorage.getItem(key);\n            return htmlAsString;\n        }\n    }\n}\n\nfunction checkStorage() {\n    var storedRecipes = [];\n\n    if (localStorage.length > 0) {\n        for (var i = 0; i < localStorage.length; i++) {\n            var key = localStorage.key(i);\n            var htmlAsString = localStorage.getItem(key);\n\n            storedRecipes.push(htmlAsString);\n        }\n        return storedRecipes;\n    } else {\n        return 0;\n    }\n}\n\n//# sourceURL=webpack:///./src/js/models/Like.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.getListOfIngredients = getListOfIngredients;\nexports.updateShoppingList = updateShoppingList;\nexports.deleteShoppingListItem = deleteShoppingListItem;\n\n\nvar shoppingDiv = document.querySelector('.shopping');\n\nshoppingDiv.style.display = 'none';\n\nfunction getListOfIngredients() {\n    var arrOfIngredients = [];\n    var ingredientsList = document.querySelector('.recipe__ingredient-list').querySelectorAll('li');\n\n    for (var i = 0; i < ingredientsList.length; i++) {\n        // Store the quantity, name, and unit of each ingredient in an array.\n        var currListItem = ingredientsList[i];\n        var quantity = currListItem.querySelector('.recipe__count').textContent;\n        var unit = currListItem.querySelector('.recipe__unit').textContent;\n        var name = currListItem.querySelector('.recipe__ingredient').textContent;\n        var ingredient = {\n            quantity: quantity,\n            unit: unit,\n            name: name\n        };\n\n        arrOfIngredients.push(ingredient);\n    }\n    return arrOfIngredients;\n}\n\nfunction updateShoppingList(ingredientList) {\n    var shoppingList = document.querySelector('.shopping__list');\n\n    for (var i = 0; i < ingredientList.length; i++) {\n        // Insert a new shopping list item with the current object's quantity, unit, and name.\n        var currListItem = ingredientList[i];\n        var quantity = currListItem.quantity;\n        var unit = currListItem.unit;\n        var name = currListItem.name;\n\n        shoppingList.insertAdjacentHTML('beforeend', '<li class=\"shopping__item\"> <div class=\"shopping__count\"> <input type=\"number\" value=\"' + quantity + '\" step=\"100\"> <p>' + unit + '</p> </div> <p class=\"shopping__description\">' + name + '</p> <button class=\"shopping__delete btn-tiny\"> <svg> <use href=\"img/icons.svg#icon-circle-with-cross\"></use> </svg> </button> </li>');\n    }\n}\n\nfunction deleteShoppingListItem(event) {\n    var shoppingListItem = document.querySelector('.shopping__list').querySelectorAll('li');\n\n    for (var i = 0; i < shoppingListItem.length; i++) {\n        if (shoppingListItem[i].querySelector('.shopping__delete, btn-tiny').contains(event.target)) {\n            shoppingListItem[i].remove();\n        }\n    }\n}\n\n//# sourceURL=webpack:///./src/js/views/listView.js?");
